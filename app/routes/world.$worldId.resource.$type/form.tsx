        ...
        <div className="w-[350px] p-2">
          <div className="grid w-full items-center gap-4">
            <div className="flex flex-col space-y-1.5">
              ...
              <Input id="name" ref={nameInput} name="name" defaultValue={resource?.name} placeholder="Name of your resource" className={innerErrors?.name ? "form-input-err" : undefined} />
            ...
            <div className="flex flex-col space-y-1.5">
              ...
              <Textarea id="desc" name="desc" defaultValue={resource?.desc} placeholder="Description of your resource" />
            </div>
          </div>
        </div>
      </ScrollArea>
